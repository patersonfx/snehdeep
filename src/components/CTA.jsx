export default function CTA() {
  return (
    <section className="relative bg-cta-gradient py-24 px-6 md:px-16 overflow-hidden">
      {/* Decorative shapes */}
      ...
      <div className="container-max relative z-10 text-center">
        ...
        <h2 className="font-heading text-h2 text-white mb-5 max-w-2xl mx-auto">
          Get the Best Financial Solution Today
        </h2>

        <p className="font-body text-lg text-white/65 mb-10 max-w-xl mx-auto leading-relaxed">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          <a
            ...
            className="btn-white inline-flex items-center gap-2.5"
          >
          ...
          <a
            ...
            className="inline-flex items-center gap-2.5 border-2 border-white/40 text-white font-body font-semibold px-7 py-3.5 rounded-xl hover:bg-white hover:text-primary transition-all duration-200 active:scale-95"
          >
